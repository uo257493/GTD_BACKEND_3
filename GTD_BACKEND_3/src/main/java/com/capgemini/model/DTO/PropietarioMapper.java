...
public class PropietarioMapper {
	...
	if(propietariodto.type.equals("usuario")){
		Users usu1  = new Users(propietariodto.id,propietariodto.type,propietariodto.email,propietariodto.isAdmin, propietariodto.login, propietariodto.password, propietariodto.status, propietariodto.password2, propietariodto.groupUsers);
		return usu1;
	}
	return null;
